...
import ProfileCotainer from '../../../../container/HeaderCard/Profile';
        ...
        <div className={styles.headerRight}>
            ...
            <div style={{position:'relative'}}>
                <div className={styles.avatar} onClick={() => {
                    props.setShowProfile(show => !show);
                }}>
                    NH

                </div>
                {props.showProfile && <ProfileCotainer setShowProfile={props.setShowProfile} />}
            </div>
        </div>
    </div>
}