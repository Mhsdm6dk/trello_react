...
export default function HeaderComponent(props){
    return <div className={styles.header}>
        ...
        <i class={"fa-solid fa-list " + styles.listicon}></i>
        </div>
        <Link to="/home">
            <div className={styles.buttonLogo}>
        ...
        <div className={styles.buttonLogo+" "+styles.left}>
            <p className={styles.textButton}>Project</p><i class="fa-solid fa-angle-down"></i>
        </div>
        <div className={styles.buttonLogo+" "+styles.left}>
            <p className={styles.textButton}>Gần đây</p><i class="fa-solid fa-angle-down"></i>
        </div>
        <div className={styles.buttonLogo+" "+styles.left}>
            <p className={styles.textButton}>Đã đánh dấu sao</p><i class="fa-solid fa-angle-down"></i>
        </div>
        <div className={styles.buttonLogo+" "+styles.left} >
